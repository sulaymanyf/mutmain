...
class ArticlePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String image =
        'https://ia.tmgrup.com.tr/e90e4e/0/0/0/0/0/0?u=https://i.tmgrup.com.tr/fikriyat//album/2019/01/21/aile-hayatiyla-ilgili-ufuk-acan-35-hadis-1548065066015.jpg';
    return Scaffold(
      appBar: AppBar(
